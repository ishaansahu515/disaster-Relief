...
import { Eye, EyeOff, Loader2, Heart, Lock, Mail } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-blue-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <h2 className="mt-6 text-center text-3xl font-bold text-gray-900">
          DisasterRelief Login
        </h2>
        <p className="mt-2 text-center text-sm text-gray-600">
          Access the emergency coordination system
        </p>
      </div>
        ...
        <div className="bg-white py-8 px-4 shadow-xl rounded-lg sm:px-10 border border-gray-200">
          ...
          <div className="mb-6 p-4 bg-blue-50 rounded-lg">
            ...
            <div className="text-xs text-blue-700 space-y-1">
              <p><strong>NGO:</strong> ngo@relief.org / password123</p>
              <p><strong>Volunteer:</strong> volunteer@helper.com / password123</p>
              <p><strong>Victim:</strong> victim@help.com / password123</p>
            </div>
          </div>
