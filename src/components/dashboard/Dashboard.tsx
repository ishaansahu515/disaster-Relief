...
const Dashboard: React.FC = () => {
        ...
        return {
          ...
          stats: [
            ...
            },
            {
              ...
              value: requests.filter((r) => r.assignedTo === user?.id).length,
              icon: Users,
              color: "green",
            },
          ],
      ...
      case "victim":
        return {
          ...
          stats: [
            {
              label: "My Requests",
              value: requests.filter((r) => r.requestedBy === user?.id).length,
              icon: AlertCircle,
              color: "blue",
            },
            {
  ...
  const criticalRequests =
    user?.role === "ngo"
      ...
      : user?.role === "victim"
      ? requests.filter(
          (r) => r.urgency === "critical" && r.requestedBy === user?.id
        )
      : requests.filter((r) => r.urgency === "critical");
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {dashboardData.stats.map((stat, index) => {
            ...
            return (
              <div
                key={index}
                className={`p-6 rounded-lg border ${getColorClasses(
                  stat.color
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-6">
              ...
              <button
                onClick={() => navigate("/critical-requests")}
